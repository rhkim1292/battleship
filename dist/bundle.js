...
const mainGameLoop = (() => {
    ...
    p2Gameboard.placeShip((0,_Ship_js__WEBPACK_IMPORTED_MODULE_1__["default"])(8, 6, 3, 'v'));2
    ...
    p1.startTurn();
    _DOMHandler_js__WEBPACK_IMPORTED_MODULE_3__["default"].displayAnnouncement(`${p1.name} goes first! Pick a coordinate on ${p2.name}'s board to attack!`);
